-- Migration: Add content table for storing tool outputs
-- Purpose: Make tool outputs first-class citizens with approval workflow
...
COMMENT ON COLUMN content.workflow_step_id IS 'References the workflow step that generated this content';
